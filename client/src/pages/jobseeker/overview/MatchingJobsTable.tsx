...
const columns: GridColDef[] = [
  { field: 'title', headerName: 'Title',    sortable: false,
  hideable:false,
  disableColumnMenu:true,
  filterable:false, 
minWidth:150,
},
  { field: 'employer_name', headerName: 'Company', width: 130,   sortable: false,
  hideable:false,
  disableColumnMenu:true,
  filterable:false,
renderCell:(params) => {
  return <div className='grid gap-2'>
<img src={params.row.employer_image || "https://res.cloudinary.com/drionr2df/image/upload/v1703231072/nhgpyh8kjpvdfej8nr2d.png"} alt="" className='w-8 h-8 '/>
...
renderCell(params) {
  return <div>
    <Link to={`/jobs/${params.row?.title}/${params.row?.job_id}`} >view</Link>
  </div>
}}
];
