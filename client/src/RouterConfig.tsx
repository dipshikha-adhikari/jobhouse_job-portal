...
const EmployerRegister = lazy(
  () => import("./components/forms/EmployerRegister")
);
const JobseekerRegister = lazy(
  () => import("./components/forms/JobseekerRegister")
);
...
const JobseekerOverview = lazy(
  () => import("./pages/jobseeker/overview/index")
);
