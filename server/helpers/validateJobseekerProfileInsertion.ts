...
export const isValidEducation = (education: any) => {
    return (education.degree !== undefined &&
        education.course !== undefined && education.institute_name !== undefined && education.graduation_year !== undefined && education.location !== undefined
    )
}

export const isValidBasicInformation = (info: any) => {
    return ((info.image !== undefined || true) && info.permanent_address !== undefined &&
        info.current_address !== undefined &&
        info.gender !== undefined &&
        info.date_of_birth !== undefined && info.fullname !== undefined && info.phone_number !== undefined)
}
